"""
Starter fabfile for deploying the djcms project.
...
# CHANGEME
env.hosts = ['user@djcms.example.com']
env.code_dir = '/srv/www/djcms'
env.project_dir = '/srv/www/djcms/djcms'
env.static_root = '/srv/www/djcms/static/'
env.virtualenv = '/srv/www/djcms/.virtualenv'
env.code_repo = 'git@github.com:user/djcms.git'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/djcms/wsgi.py" % env.code_dir)
